...
const Hero: React.FC = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      description: 'Appareil de gymnastique respiratoire hypopressive pour ventre plat et tonus du périnée. Améliore votre souffle et endurance. 6 500 FCFA avec livraison partout à Abidjan.',
      color: 'purple'
    }
  ];
